...
class DotnetExec : public ModuleCmd
{
...
extern "C" __declspec(dllexport) DotnetExec * DotnetExecConstructor();

#else

extern "C"  __attribute__((visibility("default"))) DotnetExec * DotnetExecConstructor();
